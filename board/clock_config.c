...
- {id: CCM.FLEXIO1_CLK_SEL.sel, value: CCM_ANALOG.PLL5_MAIN_CLK}
- {id: CCM.FLEXIO2_CLK_SEL.sel, value: CCM_ANALOG.PLL5_MAIN_CLK}
...
- {id: CCM.SAI2_CLK_SEL.sel, value: CCM_ANALOG.PLL4_MAIN_CLK}
- {id: CCM.SAI3_CLK_SEL.sel, value: CCM_ANALOG.PLL4_MAIN_CLK}
- {id: CCM.SEMC_PODF.scale, value: '5', locked: true}
- {id: CCM.SPDIF0_CLK_SEL.sel, value: CCM_ANALOG.PLL5_MAIN_CLK}
...
- {id: CCM_ANALOG_PFD_480_PFD1_CLKGATE_CFG, value: Disabled}
- {id: CCM_ANALOG_PFD_480_PFD2_CLKGATE_CFG, value: Disabled}
- {id: CCM_ANALOG_PFD_480_PFD3_CLKGATE_CFG, value: Disabled}
- {id: CCM_ANALOG_PFD_528_PFD0_CLKGATE_CFG, value: Disabled}
- {id: CCM_ANALOG_PFD_528_PFD1_CLKGATE_CFG, value: Disabled}
- {id: CCM_ANALOG_PFD_528_PFD2_CLKGATE_CFG, value: Disabled}
- {id: CCM_ANALOG_PFD_528_PFD3_CLKGATE_CFG, value: Disabled}
- {id: CCM_ANALOG_PLL_AUDIO_ENABLE_CFG, value: Disabled}
- {id: CCM_ANALOG_PLL_ENET_ENABLE_CFG, value: Disabled}
- {id: CCM_ANALOG_PLL_ENET_ENET_25M_REF_EN_CFG, value: Disabled}
- {id: CCM_ANALOG_PLL_ENET_POWERDOWN_CFG, value: 'Yes'}
- {id: CCM_ANALOG_PLL_SYS_ENABLE_CFG, value: Disabled}
...
- {id: CCM_ANALOG_PLL_VIDEO_ENABLE_CFG, value: Disabled}
sources:
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_SetMux(kCLOCK_SpdifMux, 2);
    ...
    CLOCK_SetMux(kCLOCK_Flexio1Mux, 2);
