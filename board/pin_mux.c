...
void BOARD_DeInitUARTPins(void);
...
void BOARD_InitPins(void) {
  CLOCK_EnableClock(kCLOCK_Iomuxc);           /* iomuxc clock (iomuxc_clk_enable): 0x03u */
	...
	//Basics: UART, I2C, SPI
	//	BOARD_InitUARTPins(); //initialized by UART ctrl on uart startup
...
void BOARD_DeInitUARTPins(void) {
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_12_GPIO1_IO12, 0U);/* GPIO_AD_B0_12 is configured as GPIO RX  */
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_13_GPIO1_IO13, 0U);/* GPIO_AD_B0_12 is configured as GPIO RX  */
}
...
//  IOMUXC_SetPinMux( IOMUXC_GPIO_AD_B0_04_GPIO1_IO04, 0U);
  ...
  IOMUXC_SetPinMux( IOMUXC_GPIO_B1_15_CSI_MCLK, 0U);
  IOMUXC_SetPinMux( IOMUXC_GPIO_B1_13_CSI_VSYNC, 0U);
  IOMUXC_SetPinMux( IOMUXC_GPIO_B1_14_CSI_HSYNC, 0U);

  IOMUXC_SetPinMux( IOMUXC_GPIO_B1_04_CSI_DATA15, 0U);
  IOMUXC_SetPinMux( IOMUXC_GPIO_B1_05_CSI_DATA14, 0U);
...
void BOARD_InitSpiPins(void) {
  ...
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_SD_B0_00_LPSPI1_SCK,        /* GPIO_AD_B0_00 is configured as LPSPI3_SCK */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_SD_B0_02_LPSPI1_SDO,        /* GPIO_AD_B0_01 is configured as LPSPI3_SDO */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_SD_B0_03_LPSPI1_SDI,        /* GPIO_AD_B0_02 is configured as LPSPI3_SDI */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */

  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_SD_B0_01_LPSPI1_PCS0,       /* GPIO_AD_B0_03 is configured as LPSPI3_PCS0 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  ...
  IOMUXC_SetPinConfig(
      ...
      0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Hyst. Enable Field: Hysteresis Disabled */
  IOMUXC_SetPinConfig(
	  IOMUXC_GPIO_SD_B0_02_LPSPI1_SDO,        /* GPIO_AD_B0_01 PAD functional properties : */
      0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
                                                 ...
                                                 Hyst. Enable Field: Hysteresis Disabled */
  IOMUXC_SetPinConfig(
	  IOMUXC_GPIO_SD_B0_03_LPSPI1_SDI,        /* GPIO_AD_B0_02 PAD functional properties : */
      0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
                                                 ...
                                                 Hyst. Enable Field: Hysteresis Disabled */
  IOMUXC_SetPinConfig(
	  IOMUXC_GPIO_SD_B0_01_LPSPI1_PCS0,       /* GPIO_AD_B0_03 PAD functional properties : */
      0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOART_InitGpioPins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOART_InitGpioPins(void){
  ...
  //LCD RESET and WRX Pins:
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_02_GPIO1_IO02, 0U);
  IOMUXC_SetPinMux(IOMUXC_GPIO_SD_B0_04_GPIO3_IO16, 0U);

  //LCD Touch IRQ
  IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_14_GPIO1_IO14, 1U);
}
...
void BOARD_InitADCPins(void){
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_B1_03_GPIO1_IO19,        /* IOMUXC_GPIO_AD_B1_03 is configured as GPIO1_IO19 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */


  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_B1_03_GPIO1_IO19,        /* GPIO_AD_B1_11 PAD functional properties : */
